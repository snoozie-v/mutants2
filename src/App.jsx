...
export default function App() {
  ...
  async function fetchNFTs(userWallet, offset, limit) {
    const MINOS = connex.thor.account("0xfc18694df5db23587eec3fcfeb244a0d0bde9374");
